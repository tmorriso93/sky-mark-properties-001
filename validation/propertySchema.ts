...
export const propertyDataSchema = z.object({
    ...
    // All the validation rules for the property data
    address1: z.string().min(1, "Address line 1 must contain a value"),
    address2: z.string().optional(),
    city: z.string().min(3, "City must contain a valCity must contain at least 3 characters"),
