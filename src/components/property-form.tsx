...
export default function PropertyForm({
    ...
    return ( 
    <Form {...form}>
            {/* Our Form component and default values */}
            <form onSubmit={form.handleSubmit(handleSubmit)}>
                            ...
                            <FormItem>
                                <FormControl>
                                       <MultiImageUploader onImagesChange={(images: ImageUpload[]) => {
                                        ...
                                        urlFormatter={(image) => {
                                            if(!image.file){
                                                return `https://firebasestorage.googleapis.com/v0/b/sky-mark-properties.firebasestorage.app/o/${encodeURIComponent(image.url)}?alt=media`;
                                            }
                                            return image.url;
                                        }}
                                        />
                ...
                <Button type="submit" className="mt-4 max-w-md mx-auto w-full flex gap-2"
